...
import (
	...
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/app/module/auth"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/app/module/content"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/app/module/user"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/pkg/constant"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/pkg/middleware"
	routerPkg "github.com/tanveerprottoy/rest-api-starter-go/net-http/internal/pkg/router"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/pkg/crypto"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/pkg/data/nosql/mongodb"
	"github.com/tanveerprottoy/rest-api-starter-go/net-http/pkg/data/sql/postgres"
	...
	validatorPkg "github.com/tanveerprottoy/rest-api-starter-go/net-http/pkg/validator"
